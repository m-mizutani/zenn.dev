...
セキュリティ監視基盤を設計する際には、自組織の情報資産、システム、脅威を整理し、検知したい事象、調査したい事象、インターフェースを整理することが重要です。これによって、セキュリティ監視基盤の要件を明確にし、設計の方向性を定めることができます。本節は機能要件について整理しましたが、次回は非機能要件について整理します。