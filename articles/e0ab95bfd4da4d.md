...
OPAは[乱暴に言うと](https://zenn.dev/mizutani/articles/69553e82b34c20#%E5%85%B7%E4%BD%93%E7%9A%84%E3%81%AA%E6%A9%9F%E8%83%BD)「ポリシー（Rego）に従って入力されたJSONを別のJSONで出力するためのエンジン」なので、このデータをそのままOPAで処理すれば解決、となりそうですがこのままだといささか不都合があります。`parse` コマンドは原則1ファイルしか解析・出力ができない＆ASTそのものしか出力できないため、以下の問題が起こります。
